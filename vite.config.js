    ...
    build: {
      ...
      rollupOptions: {
        input: {
          ...
          howToInvest: path.resolve(__dirname, 'frontend', 'how-to-invest.html'),
          investorProtection: path.resolve(__dirname, 'frontend', 'investor-protection.html'),
          contactUs: path.resolve(__dirname, 'frontend', 'contact-us.html'),
          economicImpact: path.resolve(__dirname, 'frontend', 'economic-impact.html'),
          environmentalImpact: path.resolve(__dirname, 'frontend', 'environmental-impact.html'),
          socialImpact: path.resolve(__dirname, 'frontend', 'social-impact.html'),
          updates: path.resolve(__dirname, 'frontend', 'updates.html'),
          terms: path.resolve(__dirname, 'frontend', 'terms.html'),
          termsContent: path.resolve(__dirname, 'frontend', 'terms-content.html'),
          admin: path.resolve(__dirname, 'frontend', 'admin.html'),
          farmerDashboard: path.resolve(__dirname, 'frontend', 'farmer-dashboard.html'),
        },
        output: {
          format: 'es',
