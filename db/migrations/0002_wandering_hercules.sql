...
CREATE UNIQUE INDEX `creditScores_account_unique` ON `creditScores` (`account`);--> statement-breakpoint
CREATE INDEX `credit_scores_account_idx` ON `creditScores` (`account`);--> statement-breakpoint
CREATE INDEX `credit_scores_score_idx` ON `creditScores` (`currentScore`);--> statement-breakpoint
CREATE TABLE `farmer_grove_balances` (
	...
	`last_calculated_at` integer DEFAULT 1762374734306,
	`updated_at` integer DEFAULT 1762374734306,
...
CREATE TABLE `farmer_grove_earnings` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`farmer_address` text NOT NULL,
	`grove_id` integer NOT NULL,
	...
	`created_at` integer DEFAULT 1762374734304,
	`updated_at` integer DEFAULT 1762374734304,
	FOREIGN KEY (`grove_id`) REFERENCES `coffee_groves`(`id`) ON UPDATE no action ON DELETE no action,
...
CREATE TABLE `investor_balances` (
	...
	`last_calculated_at` integer DEFAULT 1762374734305,
	`updated_at` integer DEFAULT 1762374734305
);
--> statement-breakpoint
...
CREATE TABLE `investor_claims` (
	...
	`created_at` integer DEFAULT 1762374734305,
	`updated_at` integer DEFAULT 1762374734305
);
--> statement-breakpoint
...
CREATE TABLE `investor_earnings` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`investor_address` text NOT NULL,
...
CREATE TABLE `investor_token_holdings` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`investor_address` text NOT NULL,
	`grove_id` integer NOT NULL,
...
CREATE TABLE `lp_token_interest` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
...
CREATE TABLE `secondary_market_transfers` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`grove_id` integer NOT NULL,
	...
	`created_at` integer DEFAULT 1762374734306,
	FOREIGN KEY (`grove_id`) REFERENCES `coffee_groves`(`id`) ON UPDATE no action ON DELETE no action
);
--> statement-breakpoint
...
CREATE INDEX `secondary_market_transfers_date_idx` ON `secondary_market_transfers` (`transfer_date`);--> statement-breakpoint
...
CREATE TABLE `__new_coffee_groves` (
	...
	`created_at` integer DEFAULT 1762374734307,
	`updated_at` integer DEFAULT 1762374734307
);
--> statement-breakpoint
...
CREATE TABLE `__new_environmental_alerts` (
	...
	`created_at` integer DEFAULT 1762374734308,
	`resolved_at` integer,
	FOREIGN KEY (`grove_id`) REFERENCES `coffee_groves`(`id`) ON UPDATE no action ON DELETE no action,
...
CREATE TABLE `__new_farmer_balances` (
	...
	`total_withdrawn` integer DEFAULT 0 NOT NULL,
	`last_withdrawal_at` integer,
	`updated_at` integer DEFAULT 1762374734308
);
--> statement-breakpoint
...
CREATE TABLE `__new_investor_verification_history` (
	...
	`verifier_address` text,
	`reason` text,
	`timestamp` integer DEFAULT 1762374734308,
...
ALTER TABLE `loanRepayment` ADD `paymentCategory` text NOT NULL;--> statement-breakpoint
ALTER TABLE `loanRepayment` ADD `daysEarlyLate` real NOT NULL;--> statement-breakpoint
ALTER TABLE `loanRepayment` ADD `loanDuration` real NOT NULL;--> statement-breakpoint
ALTER TABLE `loanRepayment` ADD `deadline` real NOT NULL;--> statement-breakpoint
CREATE INDEX `loan_repayment_account_idx` ON `loanRepayment` (`account`);--> statement-breakpoint
CREATE INDEX `loan_repayment_loan_idx` ON `loanRepayment` (`loanId`);--> statement-breakpoint
ALTER TABLE `loans` ADD `deadline` real NOT NULL;--> statement-breakpoint
ALTER TABLE `loans` ADD `isActive` integer DEFAULT true NOT NULL;--> statement-breakpoint
ALTER TABLE `loans` ADD `isRepaid` integer DEFAULT false NOT NULL;--> statement-breakpoint
CREATE INDEX `loans_account_idx` ON `loans` (`account`);--> statement-breakpoint
CREATE INDEX `loans_is_active_idx` ON `loans` (`isActive`);